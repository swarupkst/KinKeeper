...
const Left = () => {
  ...
  return (
    ...
    <div className='flex flex-col gap-3'>
      <div key={friend.id} className='flex flex-col gap-2 justify-center items-center bg-white p-5 text-center rounded-xl shadow-sm'>
            <img className='rounded-full w-20' src={friend.picture}></img>
...
<p className='text-lg font-medium italic text-[#64748B]'>"{friend.bio}"</p>
